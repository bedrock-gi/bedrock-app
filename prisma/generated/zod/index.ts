...
export const LocationScalarFieldEnumSchema = z.enum(['id','name','createdAt','updatedAt','projectId','latitude','longitude','customColumns']);
...
export const AgsUploadScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','userId','projectId','fileUrl','status']);
